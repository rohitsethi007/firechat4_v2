      ...
      var NewPostPage = /*#__PURE__*/function () {
        ...
        _createClass(NewPostPage, [{
          ...
          value: function submitPostForm() {
            ...
            this.imageProvider.uploadPostPhotos(this.postMedia).then(function (imageUrls) {
              _this3.post.postMedia = imageUrls; // get specific data for type post

              _this3.post.data = {
                message: _this3.postForm.value.message
              }; // Add post to database.

              _this3.dataProvider.addPost(_this3.post).then(function (success) {
          ...
          value: function removeMedia(media) {
            ...
            console.log('this.postMedia:', this.postMedia); // this.imageProvider.deletePostPhoto(media);
          }
        }]);
