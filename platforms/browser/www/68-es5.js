    ...
    function () {
      ...
      _createClass(Tab, [{
        ...
        value: function componentWillLoad() {
          return regeneratorRuntime.async(function componentWillLoad$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return regeneratorRuntime.awrap(this.setActive());
        ...
        value: function setActive() {
          return regeneratorRuntime.async(function setActive$(_context2) {
            while (1) {
    ...
    function () {
      ...
      _createClass(Tabs, [{
        ...
        value: function select(tab) {
          var selectedTab;
          return regeneratorRuntime.async(function select$(_context4) {
            while (1) {
        ...
        value: function getTab(tab) {
          return regeneratorRuntime.async(function getTab$(_context5) {
            while (1) {
        ...
        value: function setRouteId(id) {
          ...
          var selectedTab;
          return regeneratorRuntime.async(function setRouteId$(_context6) {
            while (1) {
        ...
        value: function getRouteId() {
          var tabId;
          return regeneratorRuntime.async(function getRouteId$(_context7) {
            while (1) {
