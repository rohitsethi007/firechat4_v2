(function () {
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["md-transition-083fcf52-js"], {
    ...
    /***/
    function cmQl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var mdTransitionAnimation = function mdTransitionAnimation(_, opts) {
        ...
        if (leavingEl && backDirection) {
          ...
          leavingPage.addElement(Object(_index_3528f139_js__WEBPACK_IMPORTED_MODULE_5__["g"])(leavingEl)).afterStyles({
            'display': 'none'
