...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PollPageModule", function() { return PollPageModule; });
...
/* harmony import */ var _poll_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./poll.page */ "./src/app/poll/poll.page.ts");
...
PollPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PollPage", function() { return PollPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let PollPage = class PollPage {
    constructor(route, router, loadingProvider, dataProvider, firestore) {
        this.route = route;
        this.router = router;
        ...
        this.chartType = 'pie';
        this.poll = { pollTags: [], data: { pollOptions: [{ name: '' }, { name: '' }, { name: '' }, { name: '' }] }, addedByUser: {}, date: firebase_app__WEBPACK_IMPORTED_MODULE_7__["firestore"].Timestamp.now() };
        this.pollOptionForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
            selected_poll_option: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([
    ...
    getPollDetails() {
        ...
        this.dataProvider.getPollDetails(this.pollId).snapshotChanges().subscribe((p) => {
            if (p) {
                console.log('p:', p);
...
PollPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-poll',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./poll.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/poll/poll.page.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./poll.page.scss */ "./src/app/poll/poll.page.scss")).default]
    }),
...
//# sourceMappingURL=poll-poll-module-es2015.js.map