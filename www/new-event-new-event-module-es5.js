(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["new-event-new-event-module"], {
              ...
              u.snapshotChanges().subscribe(function (value) {
                ...
                if (_this.step === 1) {
                  ...
                  if (_this.user.groups) {
                    _this.firestore.collection('groups').ref.where(firebase_app__WEBPACK_IMPORTED_MODULE_12__["default"].firestore.FieldPath.documentId(), 'in', _this.user.groups).get().then(function (group) {
                      _this.groups = [];
    ...
    function uZUT(module, __webpack_exports__, __webpack_require__) {
      ...
      var NewEventPageModule = /*#__PURE__*/_createClass(function NewEventPageModule() {
