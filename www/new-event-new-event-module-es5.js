...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["new-event-new-event-module"], {
  ...
  function srcAppNewEventNewEventPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _validators_checkbox_checked_validator__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function NewEventPage(route, router, dataProvider, loadingProvider, navCtrl, http, camera, actionSheet, imageProvider) {
          ...
          this.actionSheet.create({
            ...
            buttons: [{
              ...
              handler: function handler() {
                _this7.imageProvider.uploadPostPhoto(_this7.camera.PictureSourceType.CAMERA).then(function (url) {
                  _this7.postMedia.push(url);
              ...
              text: 'Photo Library',
              handler: function handler() {
                _this7.imageProvider.getImages().then(function (url) {
                  _this7.postMedia = _this7.postMedia.concat(url);
                  console.log(url);
                });
              }
            }, {
              text: 'Video',
              handler: function handler() {
                _this7.imageProvider.uploadPostVideo().then(function (url) {
                  _this7.postMedia(url);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _services_data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"], _services_loading_service__WEBPACK_IMPORTED_MODULE_7__["LoadingService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClient"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_9__["Camera"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ActionSheetController"], _services_image_service__WEBPACK_IMPORTED_MODULE_6__["ImageService"]])], NewEventPage);
    /***/
  }
}]);
