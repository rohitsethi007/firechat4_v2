  ...
  (self["webpackChunkfirechat"] = self["webpackChunkfirechat"] || []).push([["src_app_feed_feed_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "EmojiPickerComponentModule": function EmojiPickerComponentModule() {
          return (
            /* binding */
            _EmojiPickerComponentModule
          );
        }
        /* harmony export */
      ...
      var _emoji_picker_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./emoji-picker.component */
      51064);

      var _EmojiPickerComponentModule = /*#__PURE__*/_createClass(function EmojiPickerComponentModule() {
        _classCallCheck(this, EmojiPickerComponentModule);
      });

      _EmojiPickerComponentModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _feed_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./feed.page */
      57713);
      /* harmony import */


      var _components_emoji_picker_emoji_picker_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../components/emoji-picker/emoji-picker.module */
      30780);
      ...
      _FeedPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _Users_rohitsethi_Documents_firechat4_v2_node_modules_ngtools_webpack_src_loaders_direct_resource_js_feed_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./feed.page.html */
      89605);
      /* harmony import */
      ...
      var _filter_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./filter.component */
      32346);
      /* harmony import */
      ...
      var _reaction_list_modal_reaction_list_modal_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var firebase_firestore__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! firebase/firestore */
      33527);
      /* harmony import */
      ...
      var _FeedPage = /*#__PURE__*/function () {
        function FeedPage(dataProvider, navCtrl, modalCtrl, firestore, alertCtrl, routerOutlet, loadingProvider, actionSheet, route, router, afAuth, localNotifications, fcm, plt, popoverCtrl, bookmarkService) {
          var _this = this;
        ...
        return _createClass(FeedPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.isSearchActive = false;
            this.searchSubject.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_14__.debounceTime)(300), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_15__.distinctUntilChanged)()).subscribe(function (searchTerm) {
              _this2.performSearch(searchTerm);
            }); // Subscribe to bookmark changes

            this.bookmarkService.userBookmarks$.subscribe(function (bookmarks) {
              _this2.userBookmarks = bookmarks; // Update isBookmarked for all posts

              _this2.posts = _this2.posts.map(function (post) {
                return Object.assign(Object.assign({}, post), {
                  isBookmarked: _this2.bookmarkService.isBookmarked(post.key, bookmarks)
                });
              });
            });
          }
          ...
          value: function ionViewWillEnter() {
            ...
            this.afAuth.currentUser.then(function (user) {
              _this3.loggedInUserId = user === null || user === void 0 ? void 0 : user.uid;
              console.log('Current user:', _this3.loggedInUserId); // Get Posts with snapshot changes to get real-time updates

              _this3.dataProvider.getCurrentUser().then(function (u) {
                u.get({
                  source: 'server'
                  ...
                  if (userData) {
                    _this3.userReactions = userData.userReactions || [];
                    _this3.userNotifications = userData.userNotifications || [];
                    _this3.userBookmarks = userData.userBookmarks || [];
                    _this3.loggedInUser = userData;
          ...
          key: "getFeedData",
          value: function getFeedData(event, searchTerm) {
                    ...
                    try {
                      ...
                      if (!searchTerm) {
                        ...
                        this.firstDataSet.get().then(function (po) {
                          _this4.lastDataSet = po.docs[po.docs.length - 1];
                          _this4.posts = [];

                          _this4.loadEachPostData(po);
                        });
                      } else {
                        // Split search term into keywords
                        searchTerms = searchTerm.toLowerCase().split(' ').filter(function (term) {
                          return term.length > 0;
                        }).map(function (term) {
                          return term.trim();
                        });
                        console.info('GOT searchTerms:', searchTerms); // Search using array-contains-any

                        this.firstDataSet = this.firestore.collection('posts').ref // .where('groupId', 'in', this.loggedInUser.groups)
          ...
          value: function addPostReaction(post, reactionType) {
            ...
            var r = p.reactions.find(function (el) {
              return el.addedByUser.addedByKey === _this6.loggedInUserId && el.reactionType === reactionType;
            });
            ...
            if (!r) {
              ...
              this.dataProvider.updatePostReactions(post.key, react).then(function () {
                _this6.posts[postIndex].showSmiley = true; // Update user notifications.

                if (!_this6.userNotifications.some(function (p) {
                  return p !== _this6.postId;
                })) {
                  _this6.userNotifications.push(_this6.postId);

                  _this6.dataProvider.getUser(_this6.loggedInUserId).update({
                    userNotifications: _this6.userNotifications
                  });
                } // Update user activity.


                if (!_this6.userReactions && _this6.userReactions.some(function (p) {
                  return p !== _this6.postId;
                })) {
                  _this6.userReactions.push(_this6.postId);

                  _this6.dataProvider.getUser(_this6.loggedInUserId).update({
                    userReactions: _this6.userReactions
                  });
                }
              });
            } else {
              this.firestore.collection('posts').doc(post.key).collection('reactions').doc(r.key).update({
                ...
                var increment = firebase_app__WEBPACK_IMPORTED_MODULE_8__["default"].firestore.FieldValue.increment(1);
          ...
          value: function removePostReaction(post, reactionType) {
            ...
            if (p.reactions !== undefined) {
              ...
              var reaction = p.reactions.find(function (el) {
                return el.addedByUser.addedByKey === _this7.loggedInUserId;
              });
          ...
          value: function followPost(post) {
            ...
            this.dataProvider.getUser(this.loggedInUserId).update({
              ...
              _this8.loadingProvider.showToast('You will be notified when there are new replies');
            });
          }
        }, {
          key: "unFollowPost",
          value: function unFollowPost(post) {
            ...
            this.dataProvider.getUser(this.loggedInUserId).update({
              ...
              _this9.loadingProvider.showToast('You won\'t get notifications for this post');
            });
          }
        }, {
          key: "reportPost",
          value: function reportPost(post) {
            ...
            this.dataProvider.addReports(this.loggedInUserId, post).then(function () {
              _this10.loadingProvider.showToast('Thank you for reporting the post.');
            });
          }
        }, {
          key: "deletePost",
            ...
            this.alertCtrl.create({
              ...
              buttons: [{
                ...
                handler: function handler(data) {
                  _this11.firestore.doc('posts/' + post.key)["delete"]();
                }
              }]
            }).then(function (r) {
              return r.present();
          ...
          value: function createPostOptionButtons(post) {
            ...
            var buttons = []; // Common styles for all buttons

            var buttonBaseStyle = 'action-sheet-button';
            var cancelButton = {
              text: 'Cancel',
              icon: 'close',
              role: 'cancel',
              cssClass: "".concat(buttonBaseStyle, " cancel-button"),
              handler: function handler() {
                console.log('Cancel clicked');
              }
            };
            var reportButton = {
              text: 'Report Post',
              icon: 'flag-outline',
              cssClass: "".concat(buttonBaseStyle, " report-button"),
              handler: function handler() {
                _this12.reportPost(post);
              }
            ...
            if (post.addedByUser.addedByKey === this.loggedInUserId) {
              var deletePostButton = {
                text: 'Delete Post',
                icon: 'trash-outline',
                cssClass: "".concat(buttonBaseStyle, " delete-button danger"),
                handler: function handler() {
                  _this12.deletePost(post);
                }
              };
              buttons.push(deletePostButton);
            } // Non-owner options
            else {
              var isNotificationsEnabled = (_a = this.userNotifications) === null || _a === void 0 ? void 0 : _a.some(function (el) {
                return el === post.key;
              });
              var notificationButton = {
                ...
                cssClass: "".concat(buttonBaseStyle, " notification-button").concat(isNotificationsEnabled ? ' active' : ''),
                handler: function handler() {
                  isNotificationsEnabled ? _this12.unFollowPost(post) : _this12.followPost(post);
                }
              };
            ...
            if (this.posts.length > this.maxNoOfPosts) {
              ...
              if (this.lastDataSet) {
                ...
                this.nextDataSet.onSnapshot(function (po) {
                  _this13.lastDataSet = po.docs[po.docs.length - 1];
                  console.log('po.docs.length', po.docs.length);

                  if (po.docs.length > 0) {
                    _this13.loadEachPostData(po);
                  }
          ...
          value: function loadEachPostData(po) {
            ...
            po.forEach(function (p) {
              ...
              post.key = p.id;
              post.showMore = false;
              var startDate = new Date(post.date);
              ...
              if (post.type === 'poll') {
                ...
                post.data.pollOptions = post.data.pollOptions.map(function (option, index) {
                  // Get the members array for this option (or empty array if undefined)
                  var members = option.members || [];
                  var votes = members.length; // Add to total poll count

                  post.totalPollCount += votes; // Return option with votes count
              ...
              _this14.firestore.collection('posts').doc(post.key).collection('reactions').snapshotChanges().subscribe(function (reactions) {
                var _a;
                ...
                if (reactions.length > 0) {
                  if (post.reactions.length > 0) {
                    ...
                    reactionType = ((_a = post.reactions.find(function (el) {
                      var _a;

                      return ((_a = el.addedByUser) === null || _a === void 0 ? void 0 : _a.addedByKey) === _this14.loggedInUserId;
              ...
              post.isBookmarked = ((_a = _this14.userBookmarks) === null || _a === void 0 ? void 0 : _a.includes(p.id)) || false;

              _this14.addOrUpdatePost(post);
            }); // check for bookmarks
            ...
            return (0, tslib__WEBPACK_IMPORTED_MODULE_16__.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
              ...
              return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                while (1) switch (_context4.prev = _context4.next) {
                  case 0:
                    this.isSearchActive = true; // Load searches when search is activated
                  ...
                  case 5:
                    setTimeout(function () {
                      ...
                      (_a = _this15.searchbar) === null || _a === void 0 ? void 0 : _a.setFocus();
                    }, 150);
          ...
          value: function deactivateSearch() {
            this.isSearchActive = false;
            this.searchQuery = ''; // Clear the arrays when search is deactivated
              ...
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    _context5.next = 5;
                    return this.saveRecentSearch(this.searchQuery.trim());
          ...
          value: function saveRecentSearch(term) {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_16__.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
              var userId, searchTerm, existingSearchQuery, existingSearches, trendingRef, existingDoc;
              return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                while (1) switch (_context6.prev = _context6.next) {
                  case 0:
                    userId = this.loggedInUser.userId;
                    searchTerm = term.trim().toLowerCase(); // Normalize the search term
                    // Check if this search term already exists for this user

                    existingSearchQuery = this.firestore.collection('userSearches').doc(userId).collection('searches', function (ref) {
                      return ref.where('term', '==', searchTerm).limit(1);
                    });
                    _context6.next = 5;
                    return existingSearchQuery.get().toPromise();

                  case 5:
                    existingSearches = _context6.sent;
                    ...
                    _context6.next = 9;
                    return this.firestore.collection('userSearches').doc(userId).collection('searches').add({
                      term: searchTerm,
                  ...
                  case 9:
                    ...
                    trendingRef = this.firestore.collection('trendingSearches').doc(searchTerm);
                    _context6.next = 12;
                    return trendingRef.set({
                      term: searchTerm,
                  ...
                  case 14:
                    ...
                    existingDoc = existingSearches.docs[0];
                    _context6.next = 17;
          ...
          value: function loadRecentSearches() {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_16__.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
              var _this16 = this;
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  case 0:
                    ...
                    if (user) {
                      this.firestore.collection('userSearches').doc(user.userId).collection('searches', function (ref) {
                        return ref.orderBy('timestamp', 'desc').limit(10);
                      }).snapshotChanges().subscribe(function (actions) {
                        _this16.recentSearches = actions.map(function (a) {
                          return {
                            id: a.payload.doc.id,
          ...
          key: "loadTrendingSearches",
          value: function loadTrendingSearches() {
            var _this17 = this;

            this.firestore.collection('trendingSearches', function (ref) {
              return ref.orderBy('count', 'desc').limit(5);
            }).snapshotChanges().subscribe(function (actions) {
              _this17.trendingSearches = actions.map(function (a) {
          ...
          key: "removeRecentSearch",
          value: function removeRecentSearch(searchId) {
          ...
          value: function clearSearch() {
            this.searchQuery = '';
            this.searchResults = []; // Optionally return to feed view

            this.deactivateSearch();
          }
        }, {
          key: "presentFilterPopover",
          value: function presentFilterPopover(ev) {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_16__.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
              var popover, handleKeydown, _yield$popover$onWill, data;
              ...
              return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                while (1) switch (_context8.prev = _context8.next) {
                  ...
                  case 9:
                    _yield$popover$onWill = _context8.sent;
          ...
          value: function applyFilters(filters) {
            console.log('Applying filters:', filters); // Implement your filter logic here
          }
        }, {
          key: "calculatePercentage",
          value: function calculatePercentage(votes, total) {
            if (!total || total === 0) return 0;
            return Math.round(votes / total * 100);
          }
        }, {
          key: "getPollColor",
          value: function getPollColor(index) {
            var colors = ['#4CAF50', '#2196F3', '#FF9800', '#E91E63', '#9C27B0', '#00BCD4' // cyan
            ];
          ...
          value: function toggleBookmark(post) {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_16__.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
              var userId;
              return _regeneratorRuntime().wrap(function _callee9$(_context9) {
                while (1) switch (_context9.prev = _context9.next) {
                  ...
                  case 3:
                    post.isBookmarked = _context9.sent;
      ...
      _FeedPage = (0, tslib__WEBPACK_IMPORTED_MODULE_16__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_21__.Component)({
        selector: 'app-feed',
      ...
      }), (0, tslib__WEBPACK_IMPORTED_MODULE_16__.__metadata)("design:paramtypes", [_services_data_service__WEBPACK_IMPORTED_MODULE_2__.DataService, _ionic_angular__WEBPACK_IMPORTED_MODULE_17__.NavController, _ionic_angular__WEBPACK_IMPORTED_MODULE_17__.ModalController, _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_18__.AngularFirestore, _ionic_angular__WEBPACK_IMPORTED_MODULE_17__.AlertController, _ionic_angular__WEBPACK_IMPORTED_MODULE_17__.IonRouterOutlet, _services_loading_service__WEBPACK_IMPORTED_MODULE_3__.LoadingService, _ionic_angular__WEBPACK_IMPORTED_MODULE_17__.ActionSheetController, _angular_router__WEBPACK_IMPORTED_MODULE_19__.ActivatedRoute, _angular_router__WEBPACK_IMPORTED_MODULE_19__.Router, _angular_fire_auth__WEBPACK_IMPORTED_MODULE_20__.AngularFireAuth, _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_4__.LocalNotifications, _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_7__.FCM, _ionic_angular__WEBPACK_IMPORTED_MODULE_17__.Platform, _ionic_angular__WEBPACK_IMPORTED_MODULE_17__.PopoverController, _services_bookmark_service__WEBPACK_IMPORTED_MODULE_12__.BookmarkService])], _FeedPage);
      /***/
    },
...
//# sourceMappingURL=src_app_feed_feed_module_ts-es5.js.map