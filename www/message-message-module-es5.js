...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["message-message-module"], {
  ...
  function srcAppMessageMessagePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _imagemodal_imagemodal_page__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    ...
    function () {
      ...
      router, route, dataProvider, angularfire, loadingProvider, alertCtrl, imageProvider, modalCtrl, camera, keyboard, actionSheet, contacts, geolocation) {
      ...
      _createClass(MessagePage, [{
        ...
        value: function ionViewDidEnter() {
          ...
          this.angularfire.object('/accounts/' + this.loggedInUserId + '/conversations/' + this.userId).snapshotChanges().subscribe(function (conversation) {
            if (conversation.payload.exists()) {
              ...
              _this.conversationId = conversation.payload.val().conversationId; // Get conversation
        ...
        value: function setMessagesRead() {
          ...
          firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('/conversations/' + this.conversationId + '/messages').once('value', function (snap) {
            ...
            if (snap.val() != null) {
              _this2.angularfire.object('/accounts/' + _this2.loggedInUserId + '/conversations/' + _this2.userId).update({
          ...
          if (this.message) {
            ...
            if (this.conversationId) {
              ...
              this.angularfire.list('conversations').push({
                ...
                _this5.angularfire.object('/accounts/' + _this5.loggedInUserId + '/conversations/' + _this5.userId).update({
                  conversationId: conversationId,
                  messagesRead: 1
                });

                _this5.angularfire.object('/accounts/' + _this5.userId + '/conversations/' + _this5.loggedInUserId).update({
                  conversationId: conversationId,
                  messagesRead: 0
                });
              });
        ...
        value: function enlargeImage(img) {
          this.modalCtrl.create({
            component: _imagemodal_imagemodal_page__WEBPACK_IMPORTED_MODULE_13__["ImagemodalPage"],
            componentProps: {
              img: img
            }
          }).then(function (res) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_9__["ActivatedRoute"], _services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"], _angular_fire_database__WEBPACK_IMPORTED_MODULE_6__["AngularFireDatabase"], _services_loading_service__WEBPACK_IMPORTED_MODULE_7__["LoadingService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["AlertController"], _services_image_service__WEBPACK_IMPORTED_MODULE_8__["ImageService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["ModalController"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_4__["Camera"], _ionic_native_keyboard_ngx__WEBPACK_IMPORTED_MODULE_11__["Keyboard"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["ActionSheetController"], _ionic_native_contacts_ngx__WEBPACK_IMPORTED_MODULE_10__["Contacts"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_12__["Geolocation"]])], MessagePage);
    /***/
  }
}]);
