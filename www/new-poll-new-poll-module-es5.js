...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["new-poll-new-poll-module"], {
  ...
  function srcAppNewPollNewPollPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function NewPollPage(dataProvider, loadingProvider, route, router, navCtrl) {
        var _this = this;
      ...
      _createClass(NewPollPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.pollForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(5), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(20), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required])),
        ...
        value: function done() {
          ...
          this.poll.pollTags = [];
          this.poll.pollTags = this.pollTags; // Add poll to database.

          this.dataProvider.addPoll(this.poll).then(function (success) {
            var pollId = success.key; // Add system message that group is created.
            // Add group poll details

            _this2.pollId = pollId;

            _this2.group.polls.push(_this2.pollId);
            ...
            _this2.group.messages.push({
              ...
              sender: uid,
              type: 'system',
              message: 'A new Poll has been added to the group : ' + _this2.poll.name,
              icon: 'md-contacts'
            }); // Update group data on the database.


            _this2.dataProvider.getGroup(_this2.groupId).update({
              polls: _this2.group.polls,
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"], _services_loading_service__WEBPACK_IMPORTED_MODULE_6__["LoadingService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"]])], NewPollPage);
    /***/
  }
}]);
