    ...
    function () {
      ...
      _createClass(Modal, [{
        ...
        value: function present() {
          ...
          return regeneratorRuntime.async(function present$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 8;
                  return regeneratorRuntime.awrap(Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_9__["a"])(this.delegate, container, this.component, ['ion-page'], componentProps));

                case 8:
                  this.usersElement = _context2.sent;
                  _context2.next = 11;
                  return regeneratorRuntime.awrap(Object(_index_3528f139_js__WEBPACK_IMPORTED_MODULE_10__["d"])(this.usersElement));

                case 11:
                  _context2.next = 13;
                  return regeneratorRuntime.awrap(Object(_overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_7__["e"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement));
                ...
                case 13:
                  ...
                  if (this.swipeToClose && mode === 'ios') {
                    ...
                    this.gesture = createSwipeToCloseGesture(this.el, ani, function () {
                      ...
                      _this2.animation.onFinish(function _callee() {
                        return regeneratorRuntime.async(function _callee$(_context) {
                          while (1) {
                            switch (_context.prev = _context.next) {
                              case 0:
                                _context.next = 2;
                                return regeneratorRuntime.awrap(_this2.dismiss(undefined, 'gesture'));
        ...
        value: function dismiss(data, role) {
          ...
          return regeneratorRuntime.async(function dismiss$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 2:
                  ...
                  _context3.next = 6;
                  return regeneratorRuntime.awrap(Object(_overlays_992cb809_js__WEBPACK_IMPORTED_MODULE_7__["f"])(this, data, role, 'modalLeave', iosAni, mdLeaveAnimation, this.presentingElement));
                ...
                case 6:
                  ...
                  _context3.next = 10;
                  return regeneratorRuntime.awrap(Object(_framework_delegate_c2e2e1f4_js__WEBPACK_IMPORTED_MODULE_9__["d"])(this.delegate, this.usersElement));
