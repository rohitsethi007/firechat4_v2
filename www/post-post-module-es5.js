...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["post-post-module"], {
  ...
  function srcAppPostPostPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function PostPage(dataProvider, loadingProvider, route, router, navCtrl, modalCtrl, firestore) {
      ...
      _createClass(PostPage, [{
                      ...
                      if (data !== null) {
                        ...
                        _this.dataProvider.getCurrentUser().snapshotChanges().subscribe(function (account) {
                          if (account.payload.exists()) {
                            ...
                            if (_this.post.reviews === undefined) {
                              var reviews = [];
                              reviews.push(review);

                              _this.dataProvider.addFirstPostReview(_this.postId, review);
                            } else {
                              _this.dataProvider.updatePostReviews(_this.postId, review);
                            } // this.ngOnInit();
        ...
        value: function getPostDetails() {
          ...
          this.subscription = this.dataProvider.getPostDetails(this.postId).snapshotChanges().subscribe(function (post) {
            if (post.payload.exists()) {
              var p = post.payload.data();
              p.key = post.payload.key;
              _this2.title = post.payload.data().title; // Check for Thanks

              var totalReactionCount = 0;
              var totalReviewCount = 0;

              if (p.reviews !== undefined) {
                var rev = Object.keys(p.reviews).map(function (e) {
                  totalReviewCount += 1;
                });
              }
              ...
              if (p.reactions !== undefined) {
                var _values = Object.keys(p.reactions).map(function (e) {
                  p.reactions[e].key = e;
                  return p.reactions[e];
                });

                foundHug = _values.some(function (el) {
                  return el.addedByUser.addedByKey === _this2.dataProvider.getCurrentUserId() && el.reactionType === 'Hug';
                });
              }
              ...
              if (p.reviews !== undefined) {
                ...
                var _values2 = Object.keys(p.reviews).map(function (e) {
                  p.reviews[e].key = e;
                  return p.reviews[e];
                });

                _this2.postReviews = _values2;

                _this2.postReviews.sort(function (a, b) {
        ...
        key: "submitReview",
        value: function submitReview(reviewKey) {
          var _this3 = this;
          ...
          this.dataProvider.getCurrentUser().snapshotChanges().subscribe(function (account) {
            if (account.payload.exists()) {
              ...
              review = {
                dateCreated: new Date().toString(),
                addedBy: _this3.dataProvider.getCurrentUserId(),
                addedByUsername: currentUserName,
                review: review
        ...
        value: function submitReactionSmile() {
          ...
          if (!this.post.showSmiley) {
            this.dataProvider.getCurrentUser().snapshotChanges().subscribe(function (account) {
              if (account.payload.exists()) {
                var currentUserName = account.payload.data().username;
                var reaction = {
                  key: '',
                  dateCreated: new Date().toString(),
                  // tslint:disable-next-line: max-line-length
                ...
                if (_this4.post.reactions === undefined) {
                  _this4.dataProvider.addFirstPostReactions(_this4.post.key, reaction).then(function (success) {
                    reaction.key = success.id;
                  });
                } else {
                  _this4.dataProvider.updatePostReactions(_this4.post.key, reaction).then(function (success) {
                    reaction.key = success.id;
                  });
                }

                _this4.post.showSmiley = true;
                _this4.post.totalReactionCount += 1;
              }
            });
          } else {
            var found = false;
            ...
            if (this.post.reactions !== undefined) {
              var r = this.post.reactions;
              var values = Object.keys(r).map(function (e) {
                return r[e];
              });
              var reactionIndex = values.find(function (el) {
                return el.addedByUser.addedByKey === _this4.dataProvider.getCurrentUserId() && el.reactionType === 'Thanks';
              });
          ...
          if (!this.post.showHug) {
            this.dataProvider.getCurrentUser().snapshotChanges().subscribe(function (account) {
              if (account.payload.exists()) {
                ...
                if (_this5.post.reactions === undefined) {
                  // TODO : After saving, get the key back and add!!!
                  var key = _this5.dataProvider.addFirstPostReactions(_this5.post.key, reaction);
                } else {
                  var _key = _this5.dataProvider.updatePostReactions(_this5.post.key, reaction);
                }

                _this5.post.showHug = true;
                _this5.post.totalReactionCount += 1;
              }
            });
          } else {
            var found = false;
            ...
            if (this.post.reactions !== undefined) {
              ...
              var reactionIndex = values.find(function (el) {
                return el.addedByUser.addedByKey === _this5.dataProvider.getCurrentUserId() && el.reactionType === 'Hug';
              });
        ...
        value: function submitReply() {
          ...
          this.dataProvider.getCurrentUser().snapshotChanges().subscribe(function (account) {
            if (account.payload.exists()) {
              ...
              if (_this6.post.reviews === undefined) {
                _this6.dataProvider.addFirstPostReview(_this6.postId, review);
              } else {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_data_service__WEBPACK_IMPORTED_MODULE_4__["DataService"], _services_loading_service__WEBPACK_IMPORTED_MODULE_5__["LoadingService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_7__["AngularFirestore"]])], PostPage);
    /***/
  }
}]);
