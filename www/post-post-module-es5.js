...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["post-post-module"], {
  ...
  function srcAppPostPostModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _post_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./post.page */
    ...
    PostPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicModule"], ng2_charts__WEBPACK_IMPORTED_MODULE_7__["ChartsModule"], _services_share_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_9__["ComponentsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(routes)],
  ...
  function srcAppPostPostPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var firebase_app__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! firebase/app */
    "./node_modules/firebase/app/dist/index.cjs.js");
    /* harmony import */


    var firebase_app__WEBPACK_IMPORTED_MODULE_14___default =
    /*#__PURE__*/
    __webpack_require__.n(firebase_app__WEBPACK_IMPORTED_MODULE_14__);
    ...
    function () {
      function PostPage(dataProvider, loadingProvider, route, router, firestore, actionSheet, modalCtrl, imageProvider, camera, keyboard, contacts, geolocation, alertCtrl) {
        ...
        this.post = {
          ...
          addedByUser: {},
          data: {},
          date: firebase_app__WEBPACK_IMPORTED_MODULE_14__["firestore"].Timestamp.now(),
          reviewMedia: []
        };
        this.pollOptionForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({
          selected_poll_option: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required]))
        });
        this.getPostDetails();
      }
      ...
      _createClass(PostPage, [{
          ...
          this.dataProvider.getPostDetails(this.postId).get().subscribe(function (post) {
            if (post) {
              ...
              if (p.type === 'poll') {
                ...
                _this.voted = false;
                var today = new Date();
                var de = p.data.dateEnding.toDate();
                ...
                p.data.pollOptions.forEach(function (pollOption) {
        ...
        value: function submitReactionCheckin() {
          ...
          var reaction = this.post.reactions.find(function (el) {
            return el.addedByUser.addedByKey === _this4.dataProvider.getCurrentUserId() && el.reactionType === 'Checkin';
          });
        ...
        value: function submitReactionBookmark() {
          ...
          var reaction = this.post.reactions.find(function (el) {
            return el.addedByUser.addedByKey === _this5.dataProvider.getCurrentUserId() && el.reactionType === 'Bookmark';
          });
          ...
          this.actionSheet.create({
            ...
            buttons: [{
              ...
              handler: function handler() {
                _this7.uploadingImage = true;

                _this7.imageProvider.uploadPostReactionPhoto(_this7.postId, _this7.loggedInUserId, _this7.camera.PictureSourceType.CAMERA).then(function (url) {
                  _this7.reviewMedia.push(url);

                  _this7.uploadingImage = false;
                });
              }
            }, {
              text: 'Photo Library',
              handler: function handler() {
                ...
                _this7.imageProvider.uploadPostReactionPhoto(_this7.postId, _this7.loggedInUserId, _this7.camera.PictureSourceType.PHOTOLIBRARY).then(function (url) {
                  _this7.reviewMedia.push(url);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"], _services_loading_service__WEBPACK_IMPORTED_MODULE_7__["LoadingService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_9__["AngularFirestore"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ActionSheetController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"], _services_image_service__WEBPACK_IMPORTED_MODULE_6__["ImageService"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_13__["Camera"], _ionic_native_keyboard_ngx__WEBPACK_IMPORTED_MODULE_11__["Keyboard"], _ionic_native_contacts_ngx__WEBPACK_IMPORTED_MODULE_10__["Contacts"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_12__["Geolocation"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["AlertController"]])], PostPage);
    /***/
  }
}]);
