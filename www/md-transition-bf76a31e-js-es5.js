(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["md-transition-bf76a31e-js"], {
  ...
  /***/
  function node_modulesIonicCoreDistEsmMdTransitionBf76a31eJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var mdTransitionAnimation = function mdTransitionAnimation(_, opts) {
      ...
      if (leavingEl && backDirection) {
        ...
        leavingPage.addElement(getIonPageElement(leavingEl)).fromTo('transform', "translateY(".concat(CENTER, ")"), "translateY(".concat(OFF_BOTTOM, ")")).fromTo('opacity', 1, 0);
