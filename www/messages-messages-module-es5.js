...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["messages-messages-module"], {
  ...
  function srcAppMessagesMessagesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function MessagesPage(router, afAuth, angularfire, loadingProvider, dataProvider) {
              ...
              conversations.forEach(function (conversation) {
                ...
                if (conversation) {
                  ...
                  _this.dataProvider.getUser(conversation.key).snapshotChanges().subscribe(function (user) {
                    conversation.friend = user.payload.val(); // Get conversation info.
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_6__["AngularFireAuth"], _angular_fire_database__WEBPACK_IMPORTED_MODULE_3__["AngularFireDatabase"], _services_loading_service__WEBPACK_IMPORTED_MODULE_4__["LoadingService"], _services_data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"]])], MessagesPage);
    /***/
  }
}]);
