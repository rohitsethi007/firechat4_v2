...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["event-event-module"], {
  ...
  function srcAppEventEventPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function EventPage(dataProvider, loadingProvider, route, router, navCtrl, modalCtrl) {
      ...
      _createClass(EventPage, [{
                    ...
                    modal.onDidDismiss().then(function (data) {
                      if (data !== null) {
                        ...
                        _this.dataProvider.getCurrentUser().snapshotChanges().subscribe(function (user) {
                          ...
                          if (_this.event.reviews === undefined) {
                            var reviews = [];
                            reviews.push(review);

                            _this.dataProvider.addFirstEventReview(_this.eventId, review);
                          } else {
                            _this.dataProvider.updateEventReviews(_this.eventId, review);
                          }
                        });
                      }
                    });
        ...
        value: function getEventDetails() {
          ...
          this.dataProvider.getEventDetails(this.eventId).snapshotChanges().subscribe(function (event) {
            if (event.payload.exists()) {
              var p = event.payload.data();
              p.key = event.payload.key;
              _this2.title = event.payload.data().title; // Check for Thanks
              ...
              if (p.reactions !== undefined) {
                ...
                foundCheckin = _values.some(function (el) {
                  return el.addedByUser.addedByKey === _this2.dataProvider.getCurrentUserId() && el.reactionType === 'Checkin';
                });
              }
              ...
              if (p.reviews !== undefined) {
                ...
                _this2.eventReviews = _values2;

                _this2.eventReviews.sort(function (a, b) {
        ...
        value: function removeEventReaction(event, reactionType) {
          ...
          var reactionIndex = values.find(function (el) {
            return el.addedByUser.addedByKey === _this3.dataProvider.getCurrentUserId() && el.reactionType === reactionType;
          });
        ...
        value: function submitReply() {
          ...
          this.dataProvider.getCurrentUser().snapshotChanges().subscribe(function (account) {
            if (account.payload.exists()) {
              ...
              if (_this4.event.reviews === undefined) {
                _this4.dataProvider.addFirstEventReview(_this4.eventId, review);
              } else {
                _this4.dataProvider.updateEventReviews(_this4.eventId, review);
              }
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_data_service__WEBPACK_IMPORTED_MODULE_4__["DataService"], _services_loading_service__WEBPACK_IMPORTED_MODULE_5__["LoadingService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ModalController"]])], EventPage);
    /***/
  }
}]);
