...
/* harmony import */ var _new_post_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./new-post.page */ "./src/app/new-post/new-post.page.ts");
...
let NewPostPage = class NewPostPage {
    constructor(route, router, dataProvider, imageProvider, loadingProvider) {
        ...
        this.dataProvider.getGroup(this.groupId).snapshotChanges().subscribe((group) => {
            ...
            console.log('groupTags', this.group);
