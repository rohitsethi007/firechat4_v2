    ...
    function () {
      ...
      _createClass(Refresher, [{
        ...
        value: function resetNativeRefresher(el, state) {
          return regeneratorRuntime.async(function resetNativeRefresher$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 4;
                  return regeneratorRuntime.awrap(translateElement(el, undefined));
                ...
                case 6:
                  _context.next = 8;
                  return regeneratorRuntime.awrap(transitionEndAsync(this.el.querySelector('.refresher-refreshing-icon')));
        ...
        value: function setupiOSNativeRefresher(pullingSpinner, refreshingSpinner) {
          ...
          return regeneratorRuntime.async(function setupiOSNativeRefresher$(_context2) {
            while (1) {
        ...
        value: function setupMDNativeRefresher(contentEl, pullingSpinner, refreshingSpinner) {
          ...
          return regeneratorRuntime.async(function setupMDNativeRefresher$(_context4) {
            while (1) {
                ...
                case 6:
                  _context4.t0 = {
                    ...
                    onEnd: function onEnd(ev) {
                      ...
                      Object(_core_80bde1aa_js__WEBPACK_IMPORTED_MODULE_0__["w"])(function _callee() {
                          ...
                          while (1) {
                            switch (_context3.prev = _context3.next) {
                              case 0:
                                ...
                                _context3.next = 4;
                                return regeneratorRuntime.awrap(snapBackAnimation.play());
        ...
        value: function setupNativeRefresher(contentEl) {
          ...
          return regeneratorRuntime.async(function setupNativeRefresher$(_context5) {
            while (1) {
        ...
        value: function complete() {
          return regeneratorRuntime.async(function complete$(_context7) {
            while (1) {
        ...
        value: function cancel() {
          return regeneratorRuntime.async(function cancel$(_context8) {
            while (1) {
