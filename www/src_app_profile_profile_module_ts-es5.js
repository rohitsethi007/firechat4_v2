(function () {
  ...
  (self["webpackChunkfirechat"] = self["webpackChunkfirechat"] || []).push([["src_app_profile_profile_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _Users_rohitsethi_Documents_firechat4_v2_node_modules_ngtools_webpack_src_loaders_direct_resource_js_profile_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      var src_environments_validator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var _user_profile_modal_user_profile_modal_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      ...
      var _ProfilePage = /*#__PURE__*/function () {
        function ProfilePage(loginService, dataProvider, loadingProvider, firestore, afAuth, imageProvider, alertCtrl, camera, fcm, firebaseProvider, platform, formBuilder, route, router, modalCtrl, routerOutlet, alertController) {
        ...
        return _createClass(ProfilePage, [{
          ...
          value: function getUserData() {
            ...
            this.dataProvider.getUser(this.userId).snapshotChanges().subscribe(function (user) {
              ...
              if (account != null) {
                _this.user = account;
                console.log('user data', _this.user);
                _this.title = _this.user.username; // get user Posts

                if (_this.user.userPosts) {
                  _this.firestore.collection('posts').ref.where(firebase_app__WEBPACK_IMPORTED_MODULE_11__["default"].firestore.FieldPath.documentId(), 'in', _this.user.userPosts).get().then(function (po) {
                    _this.userPosts = [];
                ...
                if (_this.user.userReactions) {
                  _this.firestore.collection('posts').ref.where(firebase_app__WEBPACK_IMPORTED_MODULE_11__["default"].firestore.FieldPath.documentId(), 'in', _this.user.userReactions).get().then(function (po) {
                    _this.userReactions = [];
                ...
                if (_this.user.userComments) {
                  _this.firestore.collection('posts').ref.where(firebase_app__WEBPACK_IMPORTED_MODULE_11__["default"].firestore.FieldPath.documentId(), 'in', _this.user.userComments).get().then(function (po) {
                    _this.userComments = [];
                ...
                if (_this.user.friends) {
                  _this.firestore.collection('accounts').ref.where(firebase_app__WEBPACK_IMPORTED_MODULE_11__["default"].firestore.FieldPath.documentId(), 'in', _this.user.friends).get().then(function (user) {
                    _this.friends = [];
                ...
                if (_this.user.groups && _this.user.groups.length > 0) {
                  _this.firestore.collection('groups').ref.where(firebase_app__WEBPACK_IMPORTED_MODULE_11__["default"].firestore.FieldPath.documentId(), 'in', _this.user.groups).get().then(function (group) {
                    _this.groups = [];
          ...
          value: function changeNotification() {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              var _this4 = this;
          ...
          value: function setPassword() {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
              var _this6 = this;
          ...
          value: function editProfile() {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
              var modal;
          ...
          value: function confirmLeaveGroup(group) {
            return (0, tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
              var _this9 = this;
          ...
          value: function leaveGroup(group) {
            ...
            var updatedMembers = group.members.filter(function (memberId) {
              return memberId !== _this10.loggedInUserId;
      ...
      _ProfilePage = (0, tslib__WEBPACK_IMPORTED_MODULE_13__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_19__.Component)({
      ...
      }), (0, tslib__WEBPACK_IMPORTED_MODULE_13__.__metadata)("design:paramtypes", [_services_login_service__WEBPACK_IMPORTED_MODULE_2__.LoginService, _services_data_service__WEBPACK_IMPORTED_MODULE_3__.DataService, _services_loading_service__WEBPACK_IMPORTED_MODULE_4__.LoadingService, _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_14__.AngularFirestore, _angular_fire_auth__WEBPACK_IMPORTED_MODULE_15__.AngularFireAuth, _services_image_service__WEBPACK_IMPORTED_MODULE_5__.ImageService, _ionic_angular__WEBPACK_IMPORTED_MODULE_16__.AlertController, _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_6__.Camera, _ionic_native_firebase_x_ngx__WEBPACK_IMPORTED_MODULE_7__.FirebaseX, _services_firebase_service__WEBPACK_IMPORTED_MODULE_9__.FirebaseService, _ionic_angular__WEBPACK_IMPORTED_MODULE_16__.Platform, _angular_forms__WEBPACK_IMPORTED_MODULE_17__.FormBuilder, _angular_router__WEBPACK_IMPORTED_MODULE_18__.ActivatedRoute, _angular_router__WEBPACK_IMPORTED_MODULE_18__.Router, _ionic_angular__WEBPACK_IMPORTED_MODULE_16__.ModalController, _ionic_angular__WEBPACK_IMPORTED_MODULE_16__.IonRouterOutlet, _ionic_angular__WEBPACK_IMPORTED_MODULE_16__.AlertController])], _ProfilePage);
      /***/
    },
