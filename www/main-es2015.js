...
let ImageService = class ImageService {
        ...
        return new Promise(resolve => {
            ...
            this.camera.getPicture(options)
                ...
                try {
                    ...
                    const buffer = yield this.file.readAsArrayBuffer(dirpath, filename);
    ...
    uploadPostVideoCapacitor() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            let photoPath = _capacitor_core__WEBPACK_IMPORTED_MODULE_10__["Capacitor"].convertFileSrc(finalPhotoUri.uri);
