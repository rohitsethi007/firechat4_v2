        ...
        _createClass(ImageService, [{
          ...
          value: function setGroupPhotoPromise(group, sourceType) {
            ...
            return new Promise(function (resolve) {
              ...
              _this15.camera.getPicture(_this15.groupPhotoOptions).then(function (imageData) {
                ...
                var gPPStorageRef = firebase__WEBPACK_IMPORTED_MODULE_3__["default"].storage().ref().child('images/' + firebase__WEBPACK_IMPORTED_MODULE_3__["default"].auth().currentUser.uid + '/' + _this15.generateFilename());
          ...
          value: function uploadPhotoMessage(conversationId, sourceType) {
            ...
            return new Promise(function (resolve) {
              ...
              _this16.camera.getPicture(_this16.photoMessageOptions).then(function (imageData) {
                ...
                var upRef = firebase__WEBPACK_IMPORTED_MODULE_3__["default"].storage().ref().child('images/' + conversationId + '/' + _this16.generateFilename());
          ...
          value: function uploadPostPhoto(sourceType) {
            ...
            return new Promise(function (resolve) {
              ...
              _this17.camera.getPicture(_this17.photoMessageOptions).then(function (imageData) {
                ...
                var upRef = firebase__WEBPACK_IMPORTED_MODULE_3__["default"].storage().ref().child('images/posts/' + _this17.generateFilename());
                upRef.put(imgBlob, metadata).then(function (snapshot) {
                  // URL of the uploaded image!
                  upRef.getDownloadURL().then(function (url) {
          ...
          value: function getDownloadUrlImage(imageBase64) {
            ...
            return new Promise(function (resolve) {
              ...
              var upRef = firebase__WEBPACK_IMPORTED_MODULE_3__["default"].storage().ref().child('images/posts/' + _this19.generateFilename());
              upRef.put(imgBlob, metadata).then(function (snapshot) {
                // URL of the uploaded image!
                upRef.getDownloadURL().then(function (url) {
                  resolve(url);
          ...
          value: function uploadPostReactionPhoto(postId, userId, sourceType) {
            ...
            return new Promise(function (resolve) {
              ...
              _this20.camera.getPicture(_this20.photoMessageOptions).then(function (imageData) {
                ...
                var upRef = firebase__WEBPACK_IMPORTED_MODULE_3__["default"].storage().ref().child('images/posts' + postId + '/' + userId + '/' + _this20.generateFilename());
                upRef.put(imgBlob, metadata).then(function (snapshot) {
                  // URL of the uploaded image!
                  upRef.getDownloadURL().then(function (url) {
          ...
          value: function uploadPostVideo() {
            ...
            return new Promise(function (resolve) {
              ...
              _this21.camera.getPicture(options).then(function (videoUrl) {
                return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this21, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
                  var _this22 = this;

                  var filename, dirpath, buffer;
                    ...
                    while (1) {
                      switch (_context7.prev = _context7.next) {
                        case 0:
                          ...
                          console.log('file exists', this.file.checkFile(dirpath, filename).then(function (sd) {
                            console.log('sd:', sd);
                          }));
                          _context7.next = 9;
                        ...
                        case 9:
                          ...
                          this.file.readAsArrayBuffer(dirpath, filename).then(function (success) {
