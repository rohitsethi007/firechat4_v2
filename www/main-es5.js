...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function $$_lazy_route_resourceLazyRecursive(module, exports, __webpack_require__) {
    var map = {
      ...
      "./group/group.module": ["./src/app/group/group.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-resource-new-resour~bfea67d4", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~newgroup-newgroup-modul~b6efb78d", "group-group-module"],
      "./groupinfo/groupinfo.module": ["./src/app/groupinfo/groupinfo.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-resource-new-resour~bfea67d4", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~newgroup-newgroup-modul~b6efb78d", "groupinfo-groupinfo-module"],
      ...
      "./message/message.module": ["./src/app/message/message.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-resource-new-resour~bfea67d4", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~newgroup-newgroup-modul~b6efb78d", "message-message-module"],
      "./messages/messages.module": ["./src/app/messages/messages.module.ts", "messages-messages-module"],
      "./new-event/new-event.module": ["./src/app/new-event/new-event.module.ts", "new-event-new-event-module"],
      "./new-poll/new-poll.module": ["./src/app/new-poll/new-poll.module.ts", "new-poll-new-poll-module"],
      "./new-resource/new-resource.module": ["./src/app/new-resource/new-resource.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-resource-new-resour~bfea67d4", "new-resource-new-resource-module"],
      "./newgroup/newgroup.module": ["./src/app/newgroup/newgroup.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-resource-new-resour~bfea67d4", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~newgroup-newgroup-modul~b6efb78d", "newgroup-newgroup-module"],
      "./poll/poll.module": ["./src/app/poll/poll.module.ts", "poll-poll-module"],
      "./popover/popover.module": ["./src/app/popover/popover.module.ts"],
      "./profile/profile.module": ["./src/app/profile/profile.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-resource-new-resour~bfea67d4", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~newgroup-newgroup-modul~b6efb78d", "default~forgot-forgot-module~login-login-module~profile-profile-module~register-register-module", "profile-profile-module"],
      ...
      "./resource/resource.module": ["./src/app/resource/resource.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-resource-new-resour~bfea67d4", "resource-resource-module"],
      ...
      "./userinfo/userinfo.module": ["./src/app/userinfo/userinfo.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-resource-new-resour~bfea67d4", "common", "userinfo-userinfo-module"],
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-resource-new-resour~bfea67d4"), __webpack_require__.e("tabs-tabs-module")]).then(__webpack_require__.bind(null,
        /*! ./tabs/tabs.module */
      ...
      loadChildren: './new-resource/new-resource.module#NewResourcePageModule',
      canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]]
    }, {
      path: 'resource/:id',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ionic_native_chooser_ngx__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
  ...
  function srcAppPopoverPopoverPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    PopoverPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])((_Object = {
      selector: 'app-popover',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./popover.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/popover/popover.page.html")).default
    }, _defineProperty(_Object, "template", "\n    <button ion-item (click)=\"close()\">Tag it as a Resource</button>\n    "), _defineProperty(_Object, "styles", [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
    /*! ./popover.page.scss */
    "./src/app/popover/popover.page.scss")).default]), _Object)), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["PopoverController"]])], PopoverPage);
    /***/
  },
  ...
  function srcAppServicesDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function DataService(afAuth, afdb, storage) {
      ...
      _createClass(DataService, [{
        ...
        value: function getUsers() {
          return this.afdb.list('/accounts', function (ref) {
        ...
        value: function getFriendRequests(userId) {
          return this.afdb.list('/requests', function (ref) {
            return ref.orderByChild('receiver').equalTo(userId);
          });
        ...
        key: "getGroups_original",
        value: function getGroups_original() {
        ...
        value: function getBlockedLists() {
          return this.afdb.list('/accounts/' + this.afAuth.auth.currentUser.uid + '/conversations', function (ref) {
            return ref.orderByChild('blocked').equalTo(true);
          });
        } // MY CODE **********************************
        ...
        value: function getGroups() {
          return this.afdb.list('/groups', function (ref) {
            return ref.orderByChild('name');
          });
        }
      }, {
        ...
        key: "updateResourceBookmark",
        value: function updateResourceBookmark(resourceKey, bookmarkedBy) {
          // this.afdb.list('/resources/' + resourceKey + '/reviews/').push(review);
          console.log("inside updateResourceBookmark");
          this.afdb.list('/resources/' + resourceKey + '/bookmarkedBy/').push(bookmarkedBy);
        }
      }, {
        key: "addFirstResourceBookmark",
        value: function addFirstResourceBookmark(resourceKey, bookmarkedBy) {
          var r = [];
          this.afdb.object('/resources/' + resourceKey).update({
            bookmarkedBy: r
          });
        ...
        key: "addUserBookmark",
        value: function addUserBookmark(userId, resourceId) {
          var r = [];
        ...
        value: function updatePollReviews(pollId, comment) {
          // this.afdb.list('/resources/' + resourceKey + '/reviews/').push(review);
          this.afdb.list('/polls/' + pollId + '/comments/').push(comment);
        }
      }, {
        key: "addFirstPollReview",
        value: function addFirstPollReview(pollId, comment) {
          var r = [];
    ...
    DataService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"], _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"], _ionic_storage__WEBPACK_IMPORTED_MODULE_4__["Storage"]])], DataService);
    /***/
  },
  ...
  function srcAppServicesShareModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [],
      declarations: [_pipes_friend__WEBPACK_IMPORTED_MODULE_2__["FriendPipe"], _pipes_conversation__WEBPACK_IMPORTED_MODULE_3__["ConversationPipe"], _pipes_group__WEBPACK_IMPORTED_MODULE_4__["GroupPipe"], _pipes_search__WEBPACK_IMPORTED_MODULE_5__["SearchPipe"], _pipes_date__WEBPACK_IMPORTED_MODULE_6__["DateFormatPipe"], _pipes_poll__WEBPACK_IMPORTED_MODULE_7__["PollPipe"], _pipes_resource__WEBPACK_IMPORTED_MODULE_8__["ResourcePipe"], angular_pipes__WEBPACK_IMPORTED_MODULE_9__["FloorPipe"]],
