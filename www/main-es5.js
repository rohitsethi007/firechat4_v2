...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function $$_lazy_route_resourceLazyRecursive(module, exports, __webpack_require__) {
    var map = {
      ...
      "./group/group.module": ["./src/app/group/group.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~659261fa", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~b8c7a92d", "group-group-module"],
      "./groupinfo/groupinfo.module": ["./src/app/groupinfo/groupinfo.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~659261fa", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~b8c7a92d", "groupinfo-groupinfo-module"],
      ...
      "./message/message.module": ["./src/app/message/message.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~659261fa", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~b8c7a92d", "message-message-module"],
      ...
      "./new-post/new-post.module": ["./src/app/new-post/new-post.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~659261fa", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~b8c7a92d", "new-post-new-post-module"],
      "./new-resources/new-resources.module": ["./src/app/new-resources/new-resources.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~659261fa", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~b8c7a92d", "default~new-event-new-event-module~new-resources-new-resources-module", "new-resources-new-resources-module"],
      "./newgroup/newgroup.module": ["./src/app/newgroup/newgroup.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~659261fa", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~b8c7a92d", "newgroup-newgroup-module"],
      "./poll/poll.module": ["./src/app/poll/poll.module.ts", "poll-poll-module"],
      "./popover/popover.module": ["./src/app/popover/popover.module.ts"],
      "./post/post.module": ["./src/app/post/post.module.ts", "post-post-module"],
      "./profile/profile.module": ["./src/app/profile/profile.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~659261fa", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~b8c7a92d", "default~forgot-forgot-module~login-login-module~profile-profile-module~register-register-module", "profile-profile-module"],
      ...
      "./userinfo/userinfo.module": ["./src/app/userinfo/userinfo.module.ts", "default~group-group-module~groupinfo-groupinfo-module~message-message-module~new-post-new-post-modul~659261fa", "common", "userinfo-userinfo-module"],
    ...
    function () {
      ...
      _createClass(DataService, [{
        ...
        value: function getUsers() {
          return this.firestore.collection('accounts'); // return this.afdb.list('/accounts', ref => ref.orderByChild('name'));
        } // Get user with username

      }, {
        key: "getUserWithUsername",
        value: function getUserWithUsername(username) {
          return this.firestore.collection('accounts').ref.where('username', '==', username); // return this.afdb.list('/accounts', ref => ref.orderByChild('username').equalTo(username));
        ...
        value: function getRequests(userId) {
          return this.firestore.collection('requests').ref.where('userId', '==', userId); // return this.afdb.object('/requests/' + userId);
        } // Get friend requests given the userId.

      }, {
        key: "getFriendRequests",
        value: function getFriendRequests(userId) {
          return this.firestore.collection('requests').ref.where('receiver', '==', userId); // return this.afdb.list('/requests', ref => ref.orderByChild('receiver').equalTo(userId));
        ...
        value: function getConversations() {
          return this.firestore.doc('accounts/' + this.userId).collection('conversations'); // return this.afdb.list('/accounts/' + this.afAuth.auth.currentUser.uid + '/conversations');
        } // Get messages of the conversation given the Id.

      }, {
        key: "getConversationMessages",
        value: function getConversationMessages(conversationId) {
          return this.firestore.doc('conversations/' + conversationId).collection('messages'); // return this.afdb.object('/conversations/' + conversationId + '/messages');
        ...
        value: function getResourceDetails(rId) {
          return this.firestore.doc('resources/' + rId); // return this.afdb.object('/resources/' + rId);
        } // Get Post details of the logged in user.

      }, {
        key: "getPostDetails",
        value: function getPostDetails(pId) {
          return this.firestore.doc('posts/' + pId); // return this.afdb.object('/posts/' + pId);
        } // Get Events details of the logged in user.

      }, {
        key: "getEventDetails",
        value: function getEventDetails(eId) {
          return this.firestore.doc('events/' + eId); // return this.afdb.object('/events/' + eId);
        } // Get Polls of the logged in user.
        ...
        value: function addPost(post) {
          return this.firestore.collection('posts').add(post); // return this.afdb.list('posts').push(post);
        }
      }, {
        key: "addEvent",
        ...
        key: "addFirstPostReview",
        value: function addFirstPostReview(postKey, review) {
          var r = []; // this.afdb.object('/posts/' + postKey).update( {
          //   reviews: r
          // });
        ...
        value: function updateEventReviews(eventKey, review) {
          // this.afdb.list('/resources/' + resourceKey + '/reviews/').push(review);
          this.firestore.doc('events/' + eventKey).collection('reviews').add(review); // this.afdb.list('/events/' + eventKey + '/reviews/').push(review);
        }
      }, {
        ...
        value: function updatePostReactions(postKey, reaction) {
          // this.afdb.list('/resources/' + resourceKey + '/reviews/').push(review);
          return this.firestore.collection('posts/' + postKey + '/reactions/').add(reaction); // var newRef = this.afdb.list('/posts/' + postKey + '/reactions/').push(reaction);
        }
      }, {
        key: "addFirstPostReactions",
        value: function addFirstPostReactions(postKey, reaction) {
          var r = [];
          this.firestore.doc('posts/' + postKey).update({
            reviews: r
        ...
        value: function removePostReaction(postKey, reactionKey) {
          this.firestore.doc('/posts/' + postKey + '/reactions/' + reactionKey).delete(); // var adaRef = this.afdb.database.ref('/posts/' + postKey + '/reactions/' + reactionKey);
          // adaRef.remove()
          //   .then(function() {
