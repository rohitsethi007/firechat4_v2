...
let GroupinfoPage = class GroupinfoPage {
    ...
    constructor(router, route, dataProvider, loadingProvider, modalCtrl, alertCtrl, angularfire, imageProvider, camera) {
        this.router = router;
        this.route = route;
    ...
    ionViewDidEnter() {
        ...
        this.dataProvider.getCurrentUser().snapshotChanges().subscribe((user) => {
            this.user = Object.assign({ $key: user.key }, user.payload.val());
        });
    }
    // Delete subscription.
    // ionViewDidLeave() {
    ...
    // View user info.
    viewUser(userId) {
        if (firebase__WEBPACK_IMPORTED_MODULE_9__["auth"]().currentUser.uid != userId)
                ...
                },
                {
                    ...
                    handler: data => {
                        ...
                        this.dataProvider.getGroup(this.groupId).update({
                            ...
                            this.angularfire.object('/accounts/' + firebase__WEBPACK_IMPORTED_MODULE_9__["auth"]().currentUser.uid + '/groups/' + this.groupId).remove().then(() => {
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: data => {
                        ...
                        this.angularfire.object('/accounts/' + firebase__WEBPACK_IMPORTED_MODULE_9__["auth"]().currentUser.uid + '/groups/' + group.$key).remove().then(() => {
