...
/* harmony import */ var _loading_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./loading.service */ 47038);
/* harmony import */ var _data_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data.service */ 28490);
...
let FirebaseService = class FirebaseService {
  ...
  sendFriendRequest(userId) {
    ...
    return (0,_Users_rohitsethi_Documents_firechat4_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.dataProvider.getRequests(loggedInUserId).get().subscribe(requests => {
        ...
        _this.firestore.collection('requests').doc(loggedInUserId).set({
          ...
          _this.dataProvider.getRequests(userId).get().subscribe(requests => {
  ...
  cancelFriendRequest(userId) {
    ...
    return (0,_Users_rohitsethi_Documents_firechat4_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      let requestsSent = [];
      _this2.dataProvider.getRequests(loggedInUserId).get().subscribe(requests => {
        requestsSent = requests.data().requestsSent;
        ...
        _this2.firestore.collection('requests').doc(loggedInUserId).set({
          ...
          let friendRequests;
          _this2.dataProvider.getRequests(userId).get().subscribe(req => {
  ...
  deleteFriendRequest(userId) {
    ...
    return (0,_Users_rohitsethi_Documents_firechat4_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      let friendRequests = [];
      _this3.dataProvider.getRequests(loggedInUserId).get().subscribe(requests => {
        friendRequests = requests.data().friendRequests;
        ...
        _this3.firestore.collection('requests').doc(loggedInUserId).set({
          ...
          let requestsSent;
          _this3.dataProvider.getRequests(userId).get().subscribe(req => {
  ...
  acceptFriendRequest(userId) {
    var _this4 = this;
    return (0,_Users_rohitsethi_Documents_firechat4_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const loggedInUserId = yield _this4.afAuth.currentUser.then(data => {
        return data.uid;
      });
      // Delete friend request.
      _this4.deleteFriendRequest(userId);
      _this4.loadingProvider.show();
      _this4.dataProvider.getUser(loggedInUserId).get().subscribe(account => {
        ...
        _this4.dataProvider.getUser(loggedInUserId).update({
          ...
          _this4.dataProvider.getUser(userId).get().subscribe(acc => {
...
FirebaseService = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Injectable)({
  providedIn: 'root'
})], FirebaseService);
...
let LoginService = class LoginService {
  constructor(afAuth, firestore, loadingProvider, router, storage) {
    this.afAuth = afAuth;
    this.firestore = firestore;
    this.loadingProvider = loadingProvider;
    this.router = router;
  ...
  reset(email) {
    ...
    return (0,_Users_rohitsethi_Documents_firechat4_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!email) {
        yield _this.loadingProvider.showToast('Please enter an email address');
        return;
      }
      if (!_this.isValidEmail(email)) {
        yield _this.loadingProvider.showToast('Please enter a valid email address');
        return;
      }
      try {
        _this.loadingProvider.show();
        ...
        yield _this.afAuth.sendPasswordResetEmail(email, actionCodeSettings);
        yield _this.loadingProvider.showToast('Password reset link sent. Please check your inbox');
      } catch (error) {
        ...
        yield _this.loadingProvider.showToast(errorMessage);
      } finally {
        _this.loadingProvider.hide();
      }
    })();
  ...
  createNewUser(userId, name, username, email, description = "I'm available", provider, img = "./assets/images/default-dp.png") {
    ...
    return (0,_Users_rohitsethi_Documents_firechat4_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        yield _this2.firestore.collection('accounts').doc(userId).set(userData);
        // Store auth state
        yield _this2.storage.set('isAuthenticated', true);
  ...
  logout() {
    return this.afAuth.signOut().then(() => this.router.navigateByUrl('/login', {
      replaceUrl: true
    }));
  }
  testFirebaseConnection() {
    console.log('Firebase config:', src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_2__.environment.firebase);
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Users_rohitsethi_Documents_firechat4_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
...
const createKeyboardController = /*#__PURE__*/function () {
  var _ref = (0,_Users_rohitsethi_Documents_firechat4_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (keyboardChangeCallback) {
    ...
    const init = /*#__PURE__*/function () {
      var _ref2 = (0,_Users_rohitsethi_Documents_firechat4_v2_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
