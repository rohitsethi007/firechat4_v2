  ...
  (self["webpackChunkfirechat"] = self["webpackChunkfirechat"] || []).push([["src_app_new-post_new-post_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "NewPostPageModule": function NewPostPageModule() {
          return (
            /* binding */
            _NewPostPageModule
          );
      ...
      var _new_post_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./new-post.page */
      13281);
      ...
      var _NewPostPageModule = /*#__PURE__*/_createClass(function NewPostPageModule() {
        _classCallCheck(this, NewPostPageModule);
      });

      _NewPostPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "NewPostPage": function NewPostPage() {
          return (
            /* binding */
            _NewPostPage
          );
      ...
      var _Users_rohitsethi_Documents_firechat4_v2_node_modules_ngtools_webpack_src_loaders_direct_resource_js_new_post_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./new-post.page.html */
      4227);
      /* harmony import */


      var _new_post_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./new-post.page.scss */
      54355);
      /* harmony import */
      ...
      var _NewPostPage = /*#__PURE__*/function () {
        function NewPostPage(route, router, dataProvider, imageProvider, loadingProvider, camera, actionSheet, firestore, ngZone) {
          ...
          this.postForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormGroup({
            title: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([// Validators.minLength(5),
            // Validators.maxLength(20),
            _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required])),
            message: new _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormControl('', _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.compose([// Validators.minLength(10),
            // Validators.maxLength(100),
            _angular_forms__WEBPACK_IMPORTED_MODULE_7__.Validators.required])) //  tags: new FormArray([], CheckboxCheckedValidator.tagsSelected(1))

          });
        }

        return _createClass(NewPostPage, [{
          key: "ionViewDidEnter",
          ...
          value: function submitPostForm() {
            ...
            this.post.type = 'general'; // Add post to database.

            this.dataProvider.addPost(this.post).then(function (success) {
              var postId = success.id;
              _this2.postId = postId;
              console.log('step 1'); // Update group data on the database.

              if (_this2.group.posts === undefined) {
                _this2.group.posts = [];
              }

              _this2.group.posts.push(_this2.postId);

              _this2.dataProvider.getGroup(_this2.groupId).update({
                posts: _this2.group.posts
              }); // Update user notifications.


              if (!_this2.userNotifications) {
                _this2.userNotifications = [_this2.postId];
              } else {
                _this2.userNotifications.push(_this2.postId);
              }

              _this2.dataProvider.getUser(_this2.addedByUser.addedByKey).update({
                userNotifications: _this2.userNotifications
              }); // Update user activity.


              if (!_this2.userPosts) {
                _this2.userPosts = [_this2.postId];
              } else {
                _this2.userPosts.push(_this2.postId);
              }

              _this2.dataProvider.getUser(_this2.addedByUser.addedByKey).update({
                userPosts: _this2.userPosts
              });
            }).then(function () {
              _this2.loadingProvider.hide();

              _this2.router.navigateByUrl('/app/tabs/tab1');
            });
            ;
          }
        }, {
          ...
          value: function selectGroup(groupId) {
            ...
            this.dataProvider.getGroup(this.groupId).snapshotChanges().subscribe(function (group) {
              _this3.group = group.payload.data(); // this.group.groupTags.forEach((element: any) => {
            ...
            this.actionSheet.create({
              ...
              buttons: [{
                ...
                handler: function handler() {
                  _this4.imageProvider.getImages().then(function (url) {
                    _this4.ngZone.run(function () {
                      _this4.postMediaImgs = [];
                      _this4.postMediaVideo = [];
                      url.forEach(function (element) {
                        _this4.postMediaImgs = _this4.postMediaImgs.concat(element);
                      });
                    });
                  });
                }
                ...
                cssClass: 'actionicon',
                handler: function handler() {
                  _this4.imageProvider.uploadPostVideo().then(function (url) {
                    _this4.postMediaVideo = [];
                    _this4.postMediaImgs = [];

                    _this4.ngZone.run(function () {
                      _this4.postMediaVideo = _this4.postMediaVideo.concat(url);
                      console.log(url);
                    });
                  });
                }
      ...
      _NewPostPage.ctorParameters = function () {
        return [{
      ...
      _NewPostPage = (0, tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_11__.Component)({
      ...
      }), (0, tslib__WEBPACK_IMPORTED_MODULE_12__.__metadata)("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_8__.ActivatedRoute, _angular_router__WEBPACK_IMPORTED_MODULE_8__.Router, _services_data_service__WEBPACK_IMPORTED_MODULE_2__.DataService, _services_image_service__WEBPACK_IMPORTED_MODULE_3__.ImageService, _services_loading_service__WEBPACK_IMPORTED_MODULE_4__.LoadingService, _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_5__.Camera, _ionic_angular__WEBPACK_IMPORTED_MODULE_9__.ActionSheetController, _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_10__.AngularFirestore, _angular_core__WEBPACK_IMPORTED_MODULE_11__.NgZone])], _NewPostPage);
      /***/
    },
...
//# sourceMappingURL=src_app_new-post_new-post_module_ts-es5.js.map