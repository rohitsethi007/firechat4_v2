(function () {
  ...
  (self["webpackChunkfirechat"] = self["webpackChunkfirechat"] || []).push([["node_modules_ionic_core_dist_esm_ion-fab_3_entry_js"], {
    /***/
    94028:
    /*!**************************************************************!*\
        ...
        return _createClass(FabButton, [{
          ...
          value: function render() {
            ...
            return (0, _index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_1__.H, {
              ...
              "class": (0, _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_3__.c)(color, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, mode, true), 'fab-button-in-list', inList), 'fab-button-translucent-in-list', inList && translucent), 'fab-button-close-active', activated), 'fab-button-show', show), 'fab-button-disabled', disabled), 'fab-button-translucent', translucent), 'ion-activatable', true), 'ion-focusable', true), "fab-button-".concat(size), size !== undefined))
