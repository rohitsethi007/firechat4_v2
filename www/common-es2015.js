...
let FirebaseService = class FirebaseService {
    constructor(angularfire, loadingProvider, afAuth, dataProvider) {
    ...
    sendFriendRequest(userId) {
        ...
        this.dataProvider.getRequests(loggedInUserId).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1)).subscribe((requests) => {
            ...
            this.angularfire.object('/requests/' + loggedInUserId).update({
                ...
                var friendRequests;
                this.dataProvider.getRequests(userId).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1)).subscribe((requests) => {
