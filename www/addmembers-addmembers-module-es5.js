...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["addmembers-addmembers-module"], {
  ...
  function srcAppAddmembersAddmembersPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      function AddmembersPage(router, route, dataProvider, loadingProvider, angularfire, alertCtrl) {
                ...
                if (account.payload.val().friends) {
                  for (var i = 0; i < account.payload.val().friends.length; i++) {
                    _this.dataProvider.getUser(account.payload.val().friends[i]).snapshotChanges().subscribe(function (friendRes) {
                      ...
                      console.log(friend);
                      if (!_this.isMember(friend)) _this.addOrUpdateFriend(friend);
                    });
                  }
            ...
            buttons: [{
              ...
              handler: function handler(data) {
                ...
                _this2.toAdd.forEach(function (friend) {
                  ...
                  _this2.angularfire.object('/accounts/' + friend.$key + '/groups/' + _this2.groupId).update({
                    messagesRead: 0
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"], _services_loading_service__WEBPACK_IMPORTED_MODULE_4__["LoadingService"], _angular_fire_database__WEBPACK_IMPORTED_MODULE_5__["AngularFireDatabase"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["AlertController"]])], AddmembersPage);
    /***/
  }
}]);
