...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["new-post-new-post-module"], {
  ...
  function srcAppNewPostNewPostPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function NewPostPage(route, router, dataProvider, imageProvider, loadingProvider, camera, actionSheet) {
        ...
        this.postForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({
          title: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([// Validators.minLength(5),
          // Validators.maxLength(20),
          _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required])),
          message: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].compose([// Validators.minLength(10),
      ...
      _createClass(NewPostPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.dataProvider.getCurrentUser().snapshotChanges().subscribe(function (value) {
            ...
            _this3.userNotifications = value.payload.data().notifications;
            _this3.post = {
        ...
        value: function submitPostForm() {
          ...
          this.post.postMedia = this.postMedia; // get specific data for type post
          ...
          this.dataProvider.addPost(this.post).then(function (success) {
            ...
            if (!_this4.userNotifications) {
              _this4.userNotifications = [_this4.postId];
            } else {
              _this4.userNotifications.push(_this4.postId);
            } // Update user data on the database.


            _this4.dataProvider.getUser(_this4.addedByUser.addedByKey).update({
              notifications: _this4.userNotifications
            }).then(function () {
              // Back.
              _this4.loadingProvider.hide();
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _services_data_service__WEBPACK_IMPORTED_MODULE_5__["DataService"], _services_image_service__WEBPACK_IMPORTED_MODULE_6__["ImageService"], _services_loading_service__WEBPACK_IMPORTED_MODULE_7__["LoadingService"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_9__["Camera"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ActionSheetController"]])], NewPostPage);
    /***/
  },
