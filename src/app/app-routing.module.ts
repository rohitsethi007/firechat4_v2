...
const routes: Routes = [
  ...
  { path: 'new-post', loadChildren: () => import('./new-post/new-post.module').then(m => m.NewPostPageModule), canActivate: [AuthGuardService] },
  ...
  { path: 'admin-groups', loadChildren: () => import('./admin-groups/admin-groups.module').then( m => m.AdminGroupsPageModule) }
];
@NgModule({
  imports: [
